...
This project won't be completed. The class ends only with the repositories since the focus of this class was the JPA entities, relationships and practice a bit of how the JpaRepository<> works.